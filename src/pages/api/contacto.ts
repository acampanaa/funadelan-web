...
export const POST: APIRoute = async ({ request }) => {
  ...
  const htmlAviso = `
    <div style="font-family:Arial,sans-serif;max-width:560px;margin:auto">
      <h2 style="font-family:Georgia,serif;color:#18335a">Nuevo mensaje de contacto</h2>
      <table style="font-size:15px;color:#1f2733;line-height:1.6">
      ...
      <p style="font-size:15px;color:#1f2733;line-height:1.7;margin-top:16px;white-space:pre-wrap;border-left:3px solid #e0a730;padding-left:12px">${escapeHtml(mensaje)}</p>
    </div>`;
  ...
  const htmlAcuse = `
    <div style="font-family:Arial,sans-serif;max-width:520px;margin:auto">
      <h1 style="font-family:Georgia,serif;color:#18335a">¡Gracias por escribirnos! ✦</h1>
      <p style="font-size:16px;line-height:1.7;color:#1f2733">
        Hola ${escapeHtml(nombre)}, recibimos tu mensaje y te responderemos pronto.
      </p>
      <p style="font-size:15px;color:#1f2733;line-height:1.6;background:#eef4fb;border-radius:8px;padding:12px">
